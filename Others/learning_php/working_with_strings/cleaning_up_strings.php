    ...
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tbl_gray_wborder">
        <tr>
          <td class="txt14b_black">            <p>              <span class="txt16b_blue">ltrim() or rtrim():</span><br>
              <span class="txt12_black">remove whitespace characters before or after the first non-whitespace character. </span><br>            
              <br>
            ...
            <p><strong><strong>&nbsp;&nbsp;&nbsp;</strong>$str =<span class="txt14b_red">&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The quick brown fox.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot; </span>;<br>
                <strong>&nbsp;&nbsp;&nbsp;</strong>echo rtrim($str);<br>
              <span class="txt14b_red">?&gt;</span></strong><br>
              <br>            
              <strong class="txt16b_blue">chop():</strong><br>
              <span class="txt12_black">this is an alias to rtrim. just use rtrim() instead.</span><br>
              <br>
              ...
              <span class="txt12_black">removes whitespace characters before and after the start and end of a string. </span><br>            
              <br>
              <span class="txt14b_red"><strong>&lt;?php</strong></span><strong><br>
              <strong>&nbsp;&nbsp;&nbsp;</strong>$str =<span class="txt14b_red">&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The quick brown fox.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot; </span>;<br>
              <strong>&nbsp;&nbsp;&nbsp;</strong>echo trim($str);<br>
              <span class="txt14b_red">?&gt;</span></strong></p>            <p align="center"><span class="txt16b_blue">The Output: </span><br>            
              <?php
