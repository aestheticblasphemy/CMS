...
<table width="100%"  border="0" cellspacing="6" cellpadding="6">
  <tr>
    <td><div align="right" class="txt24bb_white">session_register()</div></td>
  </tr>
</table>
<br>
          ...
          <td class="txt14b_black">
            <p align="center" class="txt12_black"><span class="txt16b_blue"> </span> <br>
				...
				if (session_is_registered($LOGGEDIN)) {
					if ($LOGGEDIN) {
						echo "The user is logged in! \$LOGGEDIN = ", $LOGGEDIN, "<br>";
						echo "What is the USERID? ", $USERID, "<br>";
						echo "What is the USERNAME?", $USERNAME, "<br>";
				...
				foreach ($_SESSION as $key => $val)  { 
					echo "unregistering... \$_SESSION['",$key,"']<br>";
					unset ($_SESSION[$key]); 
				} 
