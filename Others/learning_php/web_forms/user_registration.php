...
<script language="javascript">
	...
	function ResetForm() {
		...
		form.passwd.value = "";
		form.passwd2.value = "";
		form.access_period.selectedIndex = 0;
		form.state.selectedIndex = 0;
		form.q1.selectedIndex = 0;
		form.q2.selectedIndex = 0;
		form.q3.selectedIndex = 0;
		
		form.q1_sel.value = "";
		form.q2_sel.value = "";
		form.q3_sel.value = "";
		form.access_period_sel.value = "";
		form.state_sel.value = "";
	}
