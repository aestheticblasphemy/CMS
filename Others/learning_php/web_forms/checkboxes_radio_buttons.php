...
<div align="center">
  <form name="form1" method="GET" action="./scripts/process_check_radio.php">
    <div align="center">
      <p>
    ...
    <div align="center">
      ...
      Can we send your email to third-parties? </td>
                  ...
                  <tr>
                    <td height="37" colspan="2" align="left" nowrap="nowrap" class="txt12b_black">&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="37" colspan="2" align="left" nowrap="nowrap" class="txt12b_black">Check all that apply: </td>
                  </tr>
                  <tr>
                    <td height="26" colspan="2" align="left" nowrap="nowrap" class="txt12b_black"><input name="check1" type="checkbox" id="check1" value="1"> 
                      Check this one!</td>
                  </tr>
                  <tr>
                    <td height="26" colspan="2" align="left" nowrap="nowrap" class="txt12b_black"><input name="check2" type="checkbox" id="check2" value="2"> 
                      Check this one too!</td>
                  </tr>
                  <tr>
                    <td height="26" colspan="2" align="left" nowrap="nowrap" class="txt12b_black"><input name="check3" type="checkbox" id="check3" value="3">
Check me! </td>
                  </tr>
                  <tr>
                    <td height="37" colspan="2" align="left" nowrap="nowrap" class="txt12b_black">&nbsp;</td>
