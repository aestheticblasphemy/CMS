function step1()
{
    ...
    ['cache','Write permissions for cache directory'],
...
function step2()
{
    $('#content').html('<table>'
        ...
        +'</tr>'
        +'<tr><th>Password</th><td><input id="adpass" type="password"/></td>'
        +'</tr>'
        +'<tr><th>(and again)</th><td><input id="adpass2" type="password"/></td>'
        +'</tr>'
...
function step2_verify()
{
    ...
    $.post(dir+'/check-config.php',opts,step2_verify2,'json');
}
